...
#from rs_helper.operations.operations import operations_fullc
...
class Soft_and_Filament(object):
    ...
    def __init__(self, dim = 2, Nc = 10, Nv = 20, Nf = 0, Np = 10, 
        ...
        #    self.six_pi_eta_r, self.delt, self.dLf, self.eta)
    ...
    def rhs_cython(self, r_expanded, t):
        ...
        if self.periodic_bc:
            ...
            self.Fvx, self.Fvy, self.Fax, self.Fay, self.Fbx, self.Fby, self.Flcx, self.Flcy, self.Fgx, self.Fgy, self.Flx, self.Fly, self.Frx, self.Fry, self.Fbfx, self.Fbfy, self.drEdt = self.fullc_op.rhs_cython(
